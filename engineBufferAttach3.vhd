...
END engineBufferAttach3;


ARCHITECTURE behavior OF engineBufferAttach3 IS

BEGIN
    PROCESS(bufferSelect,sel_0_write_address,sel_0_write_strobe,sel_0_write_data,
                         sel_1_write_address,sel_1_write_strobe,sel_1_write_data,
                         sel_2_write_address,sel_2_write_strobe,sel_2_write_data)
    BEGIN    
        CASE bufferSelect IS
            ...
            WHEN 2 => 
                buffer_write_address <= sel_2_write_address;
                buffer_write_strobe <= sel_2_write_strobe;
                buffer_write_data <= sel_2_write_data;
            --WHEN OTHERS =>
            --    buffer_write_address <= sel_0_write_address;
            --    buffer_write_strobe <= sel_0_write_strobe;
            --    buffer_write_data <= sel_0_write_data;
